...
const groups:Record<TabKey,ServiceGroup>={
  ...
  otros:{label:"Otros servicios",intro:"Trabajos complementarios que no pertenecen directamente a mecanografía, impresión o formularios, pero ayudan a conservar información y resolver necesidades de oficina.",items:[
    ...
    ["Traducciones","Podemos ayudar con traducciones a distintos idiomas de forma limitada, según el idioma, la extensión y la complejidad del documento. Antes de aceptar el encargo revisamos el material y confirmamos si está dentro de nuestras posibilidades. No sustituye una traducción oficial o certificada cuando una institución la exige."],
    ["Diseño de sitios web","¿Desea tener un sitio web como este para presentar su negocio, oficio o proyecto? Cuéntenos su idea, los servicios que ofrece y el estilo que imagina. Podemos crear sitios informativos sencillos de forma limitada y dentro de nuestras posibilidades, acordando primero el contenido, el alcance y el mantenimiento."],
    ["Promociones para productos y servicios","Si desea promocionar un servicio o producto, pero no necesita un sitio web completo, envíenos fotografías, información, precios y datos de contacto. Prepararemos un ejemplo de publicación para que pueda revisarlo antes de utilizarlo. También le informaremos las formas disponibles para realizar el pago."],
    ["Orientación hacia otros proveedores","¿No ve aquí lo que necesita? Explíquenos su idea. Si el trabajo no está dentro de nuestros servicios o requiere equipos y conocimientos diferentes, trataremos de ponerlo en contacto con un proveedor que pueda orientarle."]
  ],photos:[
