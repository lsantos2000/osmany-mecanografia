...
export default function Tarifas(){return <Shell>
  ...
  <section className="payment-options"><div className="wrap"><div><span className="kicker light">Formas de pago</span><h2>Usted elige la opción más conveniente.</h2><p>El servicio puede pagarse en pesos cubanos o dólares estadounidenses. También pueden acordarse transferencias en CUP, MLC o USD a tarjeta, así como pagos mediante Zelle.</p><p>La moneda, el método de pago y el importe final se confirman directamente con Osmany antes de comenzar. Cuando corresponda una conversión, se informa y acuerda previamente para que ambas partes tengan claridad.</p></div><aside><b>Opciones disponibles</b><span>Efectivo en CUP</span><span>Efectivo en USD</span><span>Transferencia en CUP</span><span>Transferencia en MLC o USD</span><span>Zelle</span><small>La disponibilidad de cada opción se confirma al solicitar la cotización.</small></aside></div></section>
